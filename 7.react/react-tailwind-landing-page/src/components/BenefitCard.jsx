            ...
            <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                ...
                <div className="flex items-center mt-auto">
                    ...
                    <p className="ml-auto font-code text-xs font-bold text-neutral uppercase tracking-wider transition-all duration-300 group-hover:text-accent-lavender group-hover:translate-x-1">
                        Explore more
                        <span className="icon-[mdi--arrow-right] ml-1 transition-transform duration-300 group-hover:translate-x-1"></span>
                    </p>
                </div>
            </div>

            <div className="absolute inset-0.5 bg-bg rounded-3xl overflow-hidden">
                <div className="inset-0 opacity-0 transition-all duration-500 group-hover:opacity-20 group-hover:scale-110">
                    {item.imageUrl && (
                        <img
                            src={item.imageUrl}
                            width={380}
